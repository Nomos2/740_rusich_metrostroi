...
function ENT:InitializeSounds()
    ...
    self.SoundPositions["ring"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}
    ...
    self.SoundPositions["ring_old"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}	
    ...
    self.SoundPositions["ring_new"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}	
    ...
    self.SoundPositions["ring_1"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}
	
	self.SoundNames["ring_vityaz"] = "subway_trains/740_4/rings/ring_start1.wav"
	self.SoundPositions["ring_vityaz"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}
	
	self.SoundNames["ring_cams"] = "subway_trains/740_4/rings/ring_cam.wav"
	self.SoundPositions["ring_cams"] = {100,1e9,Vector(803-299,25.6,-26.3),0.45}
    ...
    self.SoundPositions["pneumo_disconnect_close"] = {800,1e9,Vector(795-299,40,-55),0.4}
    self.SoundPositions["pneumo_disconnect_open"] = {800,1e9,Vector(795-299,40,-55),0.4}
    ...
    self.SoundPositions["horn"] = {1100,1e9,Vector(820-299,0,-30),0.8}
    ...
    self.SoundPositions["KV_-3_-2"] = {80,1e9,Vector(830.8-299,25.3,-10)}
    ...
    self.SoundPositions["kro_in"] = {80,1e9,Vector(813.4-299,53.3,-21.1)}
    ...
    self.SoundPositions["krr_in"] = {80,1e9,Vector(810.4-299,53.9,-17.3)}
    ...
    self.SoundPositions["door_cab_roll"] = {485,1e9,Vector(516-299,0,0),0.5}
	
    self.SoundPositions["rolling_5"] = {485,1e9,Vector(520-25-140,0,0),0.4}	
    self.SoundPositions["rolling_10"] = {485,1e9,Vector(520-25-140,0,0),0.5}
    self.SoundPositions["rolling_30"] = {485,1e9,Vector(520-25-140,0,0),0.6}
    self.SoundPositions["rolling_55"] = {485,1e9,Vector(520-25-140,0,0),0.7}
    self.SoundPositions["rolling_75"] = {485,1e9,Vector(520-25-140,0,0),0.85}
    ...
    self.SoundPositions["rolling_low"] = {480,1e12,Vector(520-25-140,0,0),0.6*0.4}
    self.SoundPositions["rolling_medium2"] = {480,1e12,Vector(520-25-140,0,0),0.90*0.4}
    self.SoundPositions["rolling_high2"] = {480,1e12,Vector(520-25-140,0,0),1.00*0.4}
	
	self.SoundPositions["rolling_5_middle"] = {485,1e9,Vector(-15-16.5-140,0),0.4}
    self.SoundPositions["rolling_10_middle"] = {485,1e9,Vector(-15-16.5-140,0),0.5}
    self.SoundPositions["rolling_30_middle"] = {485,1e9,Vector(-15-16.5-140,0),0.6}
    self.SoundPositions["rolling_55_middle"] = {485,1e9,Vector(-15-16.5-140,0),0.7}
    self.SoundPositions["rolling_75_middle"] = {485,1e9,Vector(-15-16.5-140,0),0.85}
    ...
    self.SoundPositions["rolling_low_middle"] = {480,1e12,Vector(-15-16.5-140,0),0.6*0.4}
    self.SoundPositions["rolling_medium2_middle"] = {480,1e12,Vector(-15-16.5-140,0),0.90*0.4}
    self.SoundPositions["rolling_high2_middle"] = {480,1e12,Vector(-15-16.5-140,0),1.00*0.4}

    self.SoundNames["valve_brake"] = {loop=true,"subway_trains/740_4/new/stopkran_loop.wav"}
    self.SoundPositions["valve_brake"] = {100,1e9,Vector(635-140,-59.7,-41),1}
    ...
    self.SoundPositions["gv_f"] = {80,1e9,Vector(126.4-299,50,-60-23.5),0.8}
    self.SoundPositions["gv_b"] = {80,1e9,Vector(126.4-299,50,-60-23.5),0.8}
    ...
    self.SoundPositions["batt_on"] = {400,1e9,Vector(816.4-299,50,-60-23.5),0.23}
    ...
    self.SoundPositions["igla_on"] = {50,1e9,Vector(780-155-140,42.3,45.71),0.2}
    self.SoundPositions["igla_off"] = {50,1e9,Vector(780-155-140,42.3,45.71),0.2}
    self.SoundPositions["igla_start1"] = {50,1e9,Vector(780-155-140,42.3,45.71),0.2}
    self.SoundPositions["igla_start2"] = {50,1e9,Vector(780-155-140,42.3,45.71),0.2}

    self.SoundNames["emer_brake"] = {loop=true,"subway_trains/740_4/new/autostop_loop.wav"}
    self.SoundPositions["emer_brake"] = {90,1e9,Vector(780-299,-45,-75),0.85}
end
...
ENT.AnnouncerPositions = {
    {Vector(450-140,-34,55),50,0.4},
	{Vector(118-140,-34,55),50,0.2},
    {Vector(158-140,34,55),50,0.2},
    {Vector(495-140,34,55),50,0.2},
    {Vector(580-140,34,55),50,0.2},
}
ENT.Cameras = {
    {Vector(770-179-140,36,42),Angle(0,180,0),"Train.740.CameraCond"},
    {Vector(750-299,36,26),Angle(0,180,0),"Train.740.CameraPPZ"},
    {Vector(800-159-150,33,12),Angle(60,0,0),"Train.740.CameraPV"},
    {Vector(815-299,-42,-6),Angle(0,-65,0),"Train.Common.ASNP"},
    {Vector(800-299,-9,8),Angle(0,0,0),"Train.740.CameraVityaz"},
...
ENT.Spawner = {
	...
	{"models/metrostroi_train/81-740/salon/salon.mdl",pos = Vector(-15-140,0,0), ang=Angle(0,0,0)},
	{"models/metrostroi_train/81-740/salon/handrails/handrails.mdl",pos = Vector(370-165-140,-5,0), ang=Angle(0,0,0)},
	{"models/metrostroi_train/81-740/cabine/Pult/pult.mdl",pos = Vector(465.4-299, 6, 0), ang=Angle(0,0,0)},	
	{"models/metrostroi_train/81-740/salon/lamps/lamps_off.mdl", pos = Vector(-15-140,-0.2,0),ang = Angle(0,0,0)},
	{"models/metrostroi_train/81-741/body/81-741_4_front.mdl",pos = Vector(-26.5-27-470,0,0), ang=Angle(0,-180,0)},
	{"models/metrostroi_train/81-740/cabine/Pult/bucik.mdl",pos = Vector(465.4-299, 6, 0), ang=Angle(0,0,0)},
	{"models/metrostroi_train/81-740/body/Garm.mdl",pos = Vector(330-15-140,0,-1.5), ang=Angle(0,0,0)},
	{"models/metrostroi_train/81-740/salon/salon_rear.mdl",pos = Vector(-544-15-140, 0, 5.5), ang=Angle(0,180,0)},
	{"models/metrostroi_train/81-741/salon/lamps/lamps_off.mdl",pos = Vector(-334.1-15-140, 0.1, -0.4), ang=Angle(0,0,0)},
	{"models/metrostroi_train/81-740/salon/handrails/handrails_r.mdl",pos = Vector(-463.5-140, -1, -75), ang = Angle(0,180,0)},
	{"models/metrostroi_train/81-740/body/krepezh.mdl",pos = Vector(283-15-140,2,-74.6),ang = Angle(0,0,0)},
	{"models/metrostroi_train/81-740/body/krepezh.mdl",pos = Vector(-270-5-140,1,-74.6),ang = Angle(0,-180,0)},
    {"models/metrostroi_train/81-740/cabine/electric/paneltex.mdl",pos = Vector(735.5-299,50,50),ang = Angle(180,270,0)},	
	},
