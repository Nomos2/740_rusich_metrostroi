...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("SFV34","Relay","Switch",{normally_closed = true,bass=true})
    self.Train:LoadSystem("SFV35","Relay","Switch",{normally_closed = true,bass=true})
...
function TRAIN_SYSTEM:Think()
    if self.ControllerTimer and CurTime() - self.ControllerTimer > 0.06 and self.Controller ~= self.TargetController then
        ...
        self.Train:PlayOnce("KV_"..previousPosition.."_"..self.Controller, "cabin",self.TargetController == self.Controller and 1.3 or 1.4)
    end
